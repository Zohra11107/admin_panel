                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a href="" class="btn btn-sm btn-info">Add user</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                                    ...
                                    <td>Admin Admin</td>
                                    <td>
                                        <a href="mailto:admin@argon.com">admin@admin.com</a>
                                    </td>
                                    <td>12/02/2021 11:00</td>
                                    <td class="text-right">
                                        <div class="dropdown">
...
<div class="col-xl-6">
    <div class="copyright text-center text-xl-left text-muted">
        © 2021 <a href="" class="font-weight-bold ml-1" target="_blank">By Zohra Baraki</a>
    </div>
</div>
</div></footer>    </div>
    </div>
